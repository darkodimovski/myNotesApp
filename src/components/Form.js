...
return (
    <div>
        <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="note">
                <textarea 
                    className='min-w-full mb-2 px-3 py-1 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-400 pb-12'
                    required
                    value={item.note}
